...
const SCOOPS_BUILD = 'adaptive-learning-v14-2026-08-03';
const WELCOME_TEMPLATE_VERSION = 'welcome-inline-profile-v5';
const REPORT_TEMPLATE_VERSION = 'adaptive-path-comprehension-v10';
const PDF_TEMPLATE_VERSION = 'adaptive-progress-pdf-v3';
...
function progressAreaLabel(key) {
  return ({ phonics: 'Phonics', vocabulary: 'Vocabulary', spelling: 'Spelling', comprehension: 'Comprehension' })[key] || String(key || 'Learning area');
}
      ...
      <div style="margin:0 0 14px;padding:15px;background:#fcfaff;border:2px solid #e0d4f7;border-radius:16px;">
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:separate;margin:0 -6px;width:calc(100% + 12px);">
          ...
          <tr>
            ...
            <td class="scoops-two-col" width="50%" style="width:50%;padding:6px;vertical-align:top;">${reportProgressRow('Reading Comprehension', report.categoryDetails.comprehension, '#64b5f6')}</td>
          </tr>
        </table>
      ...
      <div style="margin:0 0 14px;padding:15px;background:#ffffff;border:2px solid #e0d4f7;border-radius:16px;">
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:separate;margin:0 -4px;width:calc(100% + 8px);">
          ...
          <tr>
            ...
            ${reportMistakeCell(report.categoryDetails.comprehension?.findings || report.mistakeDetails.find(item => item.area === 'Comprehension'))}
          </tr>
        </table>
      </div>
...
const server = http.createServer(async (request, response) => {
  ...
  if (pathname === '/health' || pathname === '/api/health') {
    return sendJson(response, 200, {
      ...
      adaptiveLearning: 'setup-diagnostic-wordbuilder-comprehension-v1',
